...
impl Spatula {
    pub fn get_offset(&self) -> u32 {
        match *self {
            Spatula::OnTopOfThePineapple => 0xa8,
            Spatula::OnTopOfShadyShoals => 0xcf,
            Spatula::OnTopOfTheChumBucket => 0xd0,
            Spatula::SpongebobsCloset => 0x5d,
            Spatula::AnnoySquidward => 0x26,
            Spatula::AmbushAtTheTreeDome => 0x3a,
            Spatula::InfestationAtTheKrustyKrab => 0xce,
            Spatula::AWallJumpInTheBucket => 0x2a,
            Spatula::TopOfTheHill => 0xc8,
            Spatula::CowaBungee => 0xc9,
            Spatula::Spelunking => 0xd8,
            Spatula::PatricksDilemma => 0xd7,
            Spatula::NavigateTheCanyonsAndMesas => 0xfa,
            Spatula::DrainTheLake => 0xea,
            Spatula::SlideLeap => 0x58,
            Spatula::DefeatKingJellyfish => 0x128,
            Spatula::EndOfTheRoad => 0xba,
            Spatula::LearnSandysMoves => 0xb9,
            Spatula::TikisGoBoom => 0x111,
            Spatula::AcrossTheRooftops => 0xab,
            Spatula::SwinginSandy => 0xac,
            Spatula::AmbushInTheLighthouse => 0x53,
            Spatula::ExtremeBungee => 0x99,
            Spatula::ComeBackWithTheCruiseBubble => 0x9a,
            Spatula::KingOfTheCastle => 0x12a,
            Spatula::ConnectTheTowers => 0x154,
            Spatula::SaveTheChildren => 0x153,
            Spatula::OverTheMoat => 0x12b,
            Spatula::ThroughTheSeaCaves => 0x5c,
            Spatula::CleanOutTheBumperBoats => 0xff,
            Spatula::SlipAndSlideUnderThePier => 0xfd,
            Spatula::TowerBungee => 0xfe,
            Spatula::RumbleAtThePoseidome => 0x28,
            Spatula::GetToTheMuseum => 0xff,
            Spatula::SlipSlidingAway => 0xfe,
            Spatula::ReturnTheMuseumsArt => 0x105,
            Spatula::SwingalongSpatula => 0x107,
            Spatula::PlunderingRobotsInTheMuseum => 0x76,
            Spatula::AcrossTheTrenchOfDarkness => 0xa5,
            Spatula::LasersAreFunAndGoodForYou => 0xa4,
            Spatula::HowInTarnationDoYouGetThere => 0xa3,
            Spatula::TopOfTheEntranceAreaML => 0x72,
            Spatula::TopOfTheComputerArea => 0x6a,
            Spatula::ShutDownTheSecuritySystem => 0x6b,
            Spatula::TheFunnelMachines => 0x68,
            Spatula::TheSpinningTowersOfPower => 0x69,
            Spatula::TopOfTheSecurityTunnel => 0x9a,
            Spatula::CompleteTheRollingBallRoom => 0x45,
            Spatula::DefeatPrawn => 0x39,
            Spatula::FrostyBungee => 0x5d,
            Spatula::TopOfTheLodge => 0x5e,
            Spatula::DefeatRobotsOnGuppyMound => 0x91,
            Spatula::BeatMrsPuffsTime => 0x92,
            Spatula::DefeatRobotsOnFlounderHill => 0xa8,
            Spatula::BeatBubbleBuddysTime => 0xa9,
            Spatula::DefeatRobotsOnSandMountain => 0xcd,
            Spatula::BeatLarrysTime => 0xcc,
            Spatula::RoboPatrickAhoy => 0x28,
            Spatula::ThroughTheWoods => 0x94,
            Spatula::FindAllTheLostCampers => 0x8d,
            Spatula::TikiRoundup => 0x83,
            Spatula::DownInTheSwamp => 0x84,
            Spatula::ThroughTheKelpCaves => 0x5a,
            Spatula::PowerCrystalCrisis => 0x53,
            Spatula::KelpVineSlide => 0x53,
            Spatula::BeatMermaidMansTime => 0x54,
            Spatula::TopOfTheEntranceAreaFDG => 0x70,
            Spatula::APathThroughTheGoo => 0x71,
            Spatula::GooTankerAhoy => 0x6f,
            Spatula::TopOfTheStackOfShips => 0x86,
            Spatula::ShipwreckBungee => 0x87,
            Spatula::DestroyTheRobotShip => 0x5f,
            Spatula::GetAloftThereMatey => 0x60,
            Spatula::DefeatTheFlyingDutchman => 0x35,
            Spatula::AcrossTheDreamscape => 0x5e,
            Spatula::FollowTheBouncingBall => 0x5f,
            Spatula::SlidingTexasStyle => 0xa1,
            Spatula::SwingersAhoy => 0xa3,
            Spatula::MusicIsInTheEarOfTheBeholder => 0x22e,
            Spatula::KrabbyPattyPlatforms => 0x7f,
            Spatula::SuperBounce => 0x6e,
            Spatula::HereYouGo => 0x32,
            Spatula::KahRahTae => 0x0,
            Spatula::TheSmallShallRuleOrNot => 0x0,
        }
    }
